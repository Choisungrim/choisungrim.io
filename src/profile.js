...
const Profile = () => {
    ...
    const setCareerMsg = () => {
        return (
            "현재 액스비스에서 2024년 12월 부터 재직중이며, NestJS 기반 웹서버와 Spring Boot기반 솔루션 서버 설계 개발업무를 수행하고있는중이야,\n"+
            "(주)티라로보틱스 솔루션 개발팀에서 2022년 7월부터 2024년 7월 31일까지 근무하고.\n" +
        ...
        <div className="main_container">
            <div className="container">
                ...
                <div className="message-area">
                    <h1>이름: 최성림</h1>
                    <h3>나이: 29세</h3>
                    <h3>연락처: 010-7742-1587</h3>
                    <h3>이메일: wowilos@naver.com</h3>
                    <h3>최종학력: 동서울대학교 전문학사 / 학점은행제 컴퓨터공학 학사</h3>
                </div>
