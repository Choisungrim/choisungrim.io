                                ...
                                <div className="text-content">
                                    <ol>
                                        <li>
                                            ...
                                            <p> 원하는 인플루언서만 모아서 볼 수 있고, 요즘 핫한 인플루언서를 분야별로 순위를 볼 수 있는 플랫폼이다.</p>
                                        </li>
                                        <li>
                                            <strong>개발 소개</strong>
                                            <p>1-1. 팀 구성</p>
                                            ...
                                            <ol>
                                                ...
                                                <p>순위, 회원가입, 조회, 추천, Mylist, 관심 분야별 추천, 닉네임 자동완성 등 API 기능 구현</p>
                                                <p>DB 설계 및 쿼리튜닝</p>
                                ...
                                <div className="text-content">
                                    <ol>
                                        <li>
                                            <strong>프로젝트 개요</strong>
                                            <p>
                                            자기소개를 담은 페이지를 구성하여 이력서를 정적인 페이지를 통해 언제 어디서나 확인할 수 있게 합니다. 
                                            </p>
                                        </li>
                                        <li>
                                            <strong>개발 소개</strong>
